"""Run post-hoc probes for completed shared-trunk split-SAE runs."""
...
def parse_args():
    ...
    parser.add_argument("--out-root", type=Path, default=Path("outputs/split_sae_latent_probes"))
...
def build_probe_command(checkpoint_path, out_dir):
    probe_script = PROJECT_ROOT / "scripts" / "probe" / "probe_split_sae_latents.py"
