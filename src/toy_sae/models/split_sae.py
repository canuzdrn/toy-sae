"""Split sparse autoencoder for frozen base-AE embeddings."""
...
class SplitSparseAutoencoder(nn.Module):
    """Shared-encoder split SAE with additive good/bad reconstruction."""
